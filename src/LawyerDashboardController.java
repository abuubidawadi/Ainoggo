...
//     @FXML
//     private Label nameLabel, emailLabel, phoneLabel, specializationLabel, experienceLabel, barIdLabel, addressLabel;
...
//         // Example data
//         nameLabel.setText("Name: Advocate Rahim");
//         emailLabel.setText("Email: rahim@gmail.com");
//         phoneLabel.setText("Phone: 01712345678");
//         specializationLabel.setText("Specialization: Family Law");
//         experienceLabel.setText("Experience: 8 Years");
//         barIdLabel.setText("Bar ID: LAW12345");
//         addressLabel.setText("Address: Dhaka, Bangladesh");

//         try {
//             lawyerImageView.setImage(new Image(getClass().getResourceAsStream("/images/default_lawyer.png")));
//         } catch (Exception e) {
//             System.out.println("Lawyer image not found.");
//         }
//     }
...
//             createUpcomingCard("Client: Karim", "Date: 10 March 2026", "Time: 5:00 PM", "Issue: Property Case")
//         );

//         upcomingContainer.getChildren().add(
//             createUpcomingCard("Client: Sumi", "Date: 11 March 2026", "Time: 2:30 PM", "Issue: Divorce Consultation")
//         );
//     }
...
//         previousContainer.getChildren().add(
//             createPreviousCard("Client: Hasan", "Date: 05 March 2026", "Time: 4:00 PM", "Status: Accepted")
//         );

//         previousContainer.getChildren().add(
//             createPreviousCard("Client: Nila", "Date: 03 March 2026", "Time: 11:00 AM", "Status: Rejected")
//         );
//     }

//     private VBox createUpcomingCard(String client, String date, String time, String issue) {
...
//             upcomingContainer.getChildren().remove(card);
//             previousContainer.getChildren().add(
//                 createPreviousCard(client, date, time, "Status: Accepted")
//             );
//         });
...
//             upcomingContainer.getChildren().remove(card);
//             previousContainer.getChildren().add(
//                 createPreviousCard(client, date, time, "Status: Rejected")
//             );
//         });

//         HBox buttonBox = new HBox(10, acceptBtn, rejectBtn);

//         card.getChildren().addAll(clientLabel, dateLabel, timeLabel, issueLabel, buttonBox);
